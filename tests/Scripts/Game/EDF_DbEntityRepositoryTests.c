...
class EDF_DbRepositoryTests : SCR_AutotestSuiteBase
{
...
class EDF_Test_DbEntityRepository_AddOrUpdate_NewEntityFindByIntValue_Found : SCR_AutotestCaseBase
{
	[Step(EStage.Main)]
	void ActAndAsset()
	{
...
//------------------------------------------------------------------------------------------------
[Test("EDF_DbRepositoryTests")]
class EDF_Test_DbEntityRepository_Remove_ByInstance_Removed : SCR_AutotestCaseBase
{
	[Step(EStage.Main)]
	void ActAndAsset()
	{
